...
const Header = () => {
    ...
    return (
        <div className="absolute w-full fixed top-0 left-0 bg-white shadow-[0px_0px_6px_rgba(0,_0,_0,_0.12)] h-[4.44rem] overflow-hidden shrink-0 flex flex-row items-center justify-center p-[1.11rem] box-border gap-[1.11rem] z-[0] text-left text-[1.56rem]">
            ...
            <div className="rounded-md box-border w-[37.06rem] flex flex-row items-center justify-start p-[0.44rem] gap-[0.22rem] text-[0.78rem] text-gray-100 border-[1px] border-solid border-gray-200">
